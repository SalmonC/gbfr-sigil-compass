...
> 当前公开版为 Windows x64 `v0.2.2`。项目是非官方玩家工具，与 Cygames、发行商及平台方无关。
...
1. 打开 [Releases](https://github.com/SalmonC/gbfr-sigil-compass/releases)，下载 `Sigil-Compass-0.2.2-win-x64-portable.zip`。
...
主、副词条都可以直接选择替代因子，也可以更换、删除或添加整枚因子。候选只来自当前存档中尚未占用的真实库存；调整版保存在原排名方案下，不改变前十名的顺序。
